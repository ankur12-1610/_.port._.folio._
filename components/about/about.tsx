             ...
             <div className="flex-shrink-0 lg:pt-16 lg:px-4 md:mt-2 mb-4 md:pt-5 sm:pt-5">
                ...
                <div className="lg:px-4 lg:mt-12 ">
                    <div className="font-RobotoC font-light mt-5 dark:text-white lg:text-2xl md:text-2xl sm:text-1xl text-justify">
                        ...
                        <p className="mt-5">Feel free to reach me on my handles mentioned above (although I'm more active on <Link href="https://www.linkedin.com/in/ankur-patil-a112a3202/" passHref><a target="_blank" className="text-blue-600">Linkedin</a></Link> &#128517;). Thanks for visiting my website :) </p>
